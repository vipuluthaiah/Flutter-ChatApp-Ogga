...
import 'package:ogga/const.dart';
import 'package:ogga/widget/full_photo.dart';
        ...
        children: <Widget>[
          document['type'] == 0
              ...
              ? Container(
                  ...
                  width: 200.0,
                  decoration: BoxDecoration(gradient: LinearGradient(colors:[Color(0xffFFD8F0),Color(0xffF9DADB)] ), borderRadius: BorderRadius.circular(8.0)),
